...
def sign_up():
    if request.method == "POST":
        ...
        if user:
            ...
            new_user = User(username=username, password=generate_password_hash(password, method='scrypt'), heroes_path=heroes_path, access_lvl=Level.USER) # add e-mail for later use
